    ...
    <>
      ...
      > 
        ...
        <div className="flex justify-center fs-5 py-10 text-white  text-center">
          <span className="bi bi-person">&nbsp;&nbsp;{post.author}</span>&nbsp;&nbsp;&nbsp;&nbsp;
          <span className="bi bi-calendar-check-fill">&nbsp;&nbsp;{post.date}</span>
        </div>
        <div>
          ...
          <ol className="breadcrumb flex justify-center text-white space-x-2">
            ...
            <li className="breadcrumb-item">
              <Link to="/blogs" className="hover:text-amber-300">Blog</Link>
            </li><span>&gt;&gt;</span>
